...
class StoreQuotationDetailsRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return[
            'item_id'         => ['required','exists:sto_items,id',Rule::unique('crm_quotation_details','item_id')->where('quotation_id' , $this->route('quotation_id'))],

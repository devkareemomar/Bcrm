...
class UpdateSalesInvoiceDetailsRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'item_id'         => ['required','exists:sto_items,id',Rule::unique('crm_sales_invoice_details','item_id')->ignore($this->route('detail'),'id')->where('sales_invoice_id' , $this->route('sales_invoice_id'))],

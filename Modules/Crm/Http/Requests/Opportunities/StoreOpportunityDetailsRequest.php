...
class StoreOpportunityDetailsRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return[
            'item_id'         => ['required','exists:sto_items,id',Rule::unique('crm_opportunity_details','item_id')->where('opportunity_id' , $this->route('opportunity_id'))],

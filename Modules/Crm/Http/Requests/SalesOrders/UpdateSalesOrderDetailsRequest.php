...
class UpdateSalesOrderDetailsRequest extends FormRequest
{
    ...
    {
        return [
            'item_id'         => ['required','exists:sto_items,id',Rule::unique('crm_sales_order_details','item_id')->ignore($this->route('detail'),'id')->where('sales_order_id' , $this->route('sales_order_id'))],

...
class CreateCrmSalesInvoiceDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('crm_sales_invoice_details', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('sales_invoice_id')->constrained('crm_sales_invoices')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('crm_sales_invoice_details');
    }
}

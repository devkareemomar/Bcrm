...
class CreateCrmSalesInvoicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('crm_sales_invoices', function (Blueprint $table) {
            $table->id();

            $table->string('code')->unique();
            $table->string('subject')->nullable();
            $table->dateTime('date');
            $table->dateTime('due_date_payment')->nullable();
            ...
            $table->enum('stage', SalesInvoiceStageEnum::values());
            ...
            $table->foreignId('sales_order_id')->nullable()->constrained('crm_sales_orders')->nullOnDelete();
